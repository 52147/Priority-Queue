...
public class MaxHeap {
	...
	public void add(int element) {
		 ...
		 * and store the root node at index 
		 * 
	...
	public int pop() {
		...
		if(realSize < 1) {
			System.out.println("Dont't have any element!");
			...
			while(index <= realSize/2) {
				...
				// its value need to be exchanged with the larger value of the left and right child
